    ...
    return GestureDetector(
      ...
      child: BlocBuilder<PaymentScreenBloc, PaymentScreenState>(
        builder: (context, state) {
          TextEditingController _typeAheadController = TextEditingController(text: context.read<PaymentScreenBloc>().phoneNumberInput);
                                ...
                                TypeAheadField(
                                  textFieldConfiguration: TextFieldConfiguration(
                                    ...
                                    decoration: InputDecoration(
                                      labelText: 'Số điện thoại hoặc tên người nhận',
                                  ...
                                  itemBuilder: (context, suggestion) {
                                    Map<String, dynamic> userSuggestion = suggestion as Map<String, dynamic>;
                                    return ListTile(
                                  ...
                                  onSuggestionSelected: (suggestion) {
                                    Map<String, dynamic> userSuggestion = suggestion as Map<String, dynamic>;
                                    context.read<PaymentScreenBloc>().phoneNumberInput = userSuggestion["phone"];
                                    _typeAheadController.text = userSuggestion["phone"];
                                  },
                                ),
